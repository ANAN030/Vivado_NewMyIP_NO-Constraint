...
HD_PWD='/home/anan/git-home/Vivado_NewMyIP/MyIP_Test/MyIP_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MyIP_Adder8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MyIP_Adder8bit.tcl
